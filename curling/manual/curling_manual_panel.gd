...
[b][color=#8a4c12]新手标准：沿中线瞄准远端 Tee，旋转保持 +0.00，力量拉到 77%，第一遍先不擦冰。[/color][/b]

• [b]76%[/b] 通常停在营垒前半，[b]77%[/b] 接近圆心，[b]78%[/b] 通常停在后半；79% 已接近背线，容错很小。
• 接近 77% 时，每调整 1 个百分点，停点约改变 1.1 米。连续过短就加 1%，连续过长就减 1%。
• 擦冰只能让壶滑得更远、弯得更少，不能把过重的壶减速。看起来会短时才擦，预计已经入垒就停手。
• 持续满擦约多滑 3.2 米。若计划全程擦冰，从 [b]74–75%[/b] 起手，不要仍用 77%。
