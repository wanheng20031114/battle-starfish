...
• [b]Q / E[/b] 连续调旋；[b]鼠标滚轮[/b]逐格微调旋转，每格 0.08 rad/s；鼠标右键取消拖拽。
• 非滑行阶段可用[b]← / → 或 A / D[/b]沿赛道查看。
...
• 熟悉直投后再加旋转；旋转不改变停止时间和总路径。最大旋转约横移 1.5 米，纵向投影只少约 6 厘米，通常无需补力；应看轨迹弯向哪边，并向反方向预留瞄准量。
