...
const MAX_SPIN_RADPS := 2.0
const SPIN_KEY_RATE_RADPS := 2.0
const SPIN_WHEEL_STEP_RADPS := 0.08
const AIM_KEY_RATE_DEGPS := 2.0
const POWER_KEY_RATE_PER_SEC := 0.04
const THROW_FINE_ADJUST_MULTIPLIER := 0.125
